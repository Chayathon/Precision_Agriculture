...
function ModalMultiDeleteUser({ isOpen, onOpenChange, selectedKeys, setRefresh, deleteSuccess }) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const deletePromises = selectedKeys.map(userId => 
                fetch(`${process.env.NEXT_PUBLIC_ENDPOINT}/deleteUser/${userId}`, {
                    method: 'DELETE'
                })
            );
...
export default ModalMultiDeleteUser